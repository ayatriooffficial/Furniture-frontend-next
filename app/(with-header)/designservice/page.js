  ...
  return (
    <>
      <div>
        ...
        <div className="px-[20px] md:px-[56px] sm:px-[50px] ">
          ...
          <section>
            <div className="flex flex-col w-full space-y-4">
              ...
              <div className="flex flex-col md:flex-row w-full gap-5 justify-center ">
                <div className="flex flex-col gap-5 md:w-1/4 border border-t-4 border-t-black p-4 shadow-sm ">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="font-semibold text-lg">
                      Design question you need help with ASAP? Start a free
          ...
          <section className="mt-12">
            <div className="flex flex-col md:flex-row w-full ">
              <div className="md:w-1/2 bg-lime-100 md:py-20 md:px-10  py-10 px-5">
            ...
            <div className="flex w-full flex-col space-y-6 items-center">
              ...
              <div className="flex flex-col md:flex-row w-full gap-5">
                {ideasAndAdvice.map((curElement) => {
                  return (
                    <div className="flex flex-col items-start hover:underline cursor-pointer border rounded-sm">
                      <Image
                        width={350}
                        height={300}
